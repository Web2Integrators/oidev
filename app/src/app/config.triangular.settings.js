(function() {
    ...
    function translateConfig(triSettingsProvider, triRouteProvider, APP_LANGUAGES) {
        ...
        triSettingsProvider.setName('Office Integrators');
        triSettingsProvider.setCopyright('&copy;' + now.getFullYear() + ' officeintegrator.com');
        triSettingsProvider.setLogo('assets/images/logo.png');
        // set current version of app (shown in footer)
        triSettingsProvider.setVersion('2.5.0');
        // set the document title that appears on the browser tab
        triRouteProvider.setTitle('Office Integrator');
